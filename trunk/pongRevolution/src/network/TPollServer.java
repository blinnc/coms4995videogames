...
public class TPollServer {
  ...
  public interface AsyncIface {
    ...
    public void pollLobby(String username, AsyncMethodCallback<AsyncClient.pollLobby_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public TLobbyState pollLobby(String username) throws TException
    {
      send_pollLobby(username);
      return recv_pollLobby();
    }

    public void send_pollLobby(String username) throws TException
    {
      oprot_.writeMessageBegin(new TMessage("pollLobby", TMessageType.CALL, ++seqid_));
      pollLobby_args args = new pollLobby_args();
    ...
    public TLobbyState recv_pollLobby() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      if (msg.seqid != seqid_) {
        throw new TApplicationException(TApplicationException.BAD_SEQUENCE_ID, "pollLobby failed: out of sequence response");
      }
      pollLobby_result result = new pollLobby_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "pollLobby failed: unknown result");
    }
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void pollLobby(String username, AsyncMethodCallback<pollLobby_call> resultHandler) throws TException {
      checkReady();
      pollLobby_call method_call = new pollLobby_call(username, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }

    public static class pollLobby_call extends TAsyncMethodCall {
      private String username;
      public pollLobby_call(String username, AsyncMethodCallback<pollLobby_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.username = username;
      }

      public void write_args(TProtocol prot) throws TException {
        prot.writeMessageBegin(new TMessage("pollLobby", TMessageType.CALL, 0));
        pollLobby_args args = new pollLobby_args();
        args.setUsername(username);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public TLobbyState getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
        TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_pollLobby();
      }
    }
  ...
  public static class Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("pollLobby", new pollLobby());
    }
    ...
    private class pollLobby implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        pollLobby_args args = new pollLobby_args();
        try {
          ...
          iprot.readMessageEnd();
          TApplicationException x = new TApplicationException(TApplicationException.PROTOCOL_ERROR, e.getMessage());
          oprot.writeMessageBegin(new TMessage("pollLobby", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        ...
        iprot.readMessageEnd();
        pollLobby_result result = new pollLobby_result();
        result.success = iface_.pollLobby(args.username);
        oprot.writeMessageBegin(new TMessage("pollLobby", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
  ...
  public static class pollLobby_args implements TBase<pollLobby_args, pollLobby_args._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("pollLobby_args");
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(pollLobby_args.class, metaDataMap);
    }

    public pollLobby_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public pollLobby_args(pollLobby_args other) {
      if (other.isSetUsername()) {
        this.username = other.username;
      }
    }

    public pollLobby_args deepCopy() {
      return new pollLobby_args(this);
    }
    ...
    public pollLobby_args setUsername(String username) {
      this.username = username;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof pollLobby_args)
        return this.equals((pollLobby_args)that);
      return false;
    }

    public boolean equals(pollLobby_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(pollLobby_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      pollLobby_args typedOther = (pollLobby_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("pollLobby_args(");
      boolean first = true;
  ...
  public static class pollLobby_result implements TBase<pollLobby_result, pollLobby_result._Fields>, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("pollLobby_result");

    private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.STRUCT, (short)0);

    public TLobbyState success;
    ...
    static {
      Map<_Fields, FieldMetaData> tmpMap = new EnumMap<_Fields, FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, TLobbyState.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      FieldMetaData.addStructMetaDataMap(pollLobby_result.class, metaDataMap);
    }

    public pollLobby_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public pollLobby_result(pollLobby_result other) {
      if (other.isSetSuccess()) {
        this.success = new TLobbyState(other.success);
      }
    }

    public pollLobby_result deepCopy() {
      return new pollLobby_result(this);
    }
    ...
    public TLobbyState getSuccess() {
      return this.success;
    }

    public pollLobby_result setSuccess(TLobbyState success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof pollLobby_result)
        return this.equals((pollLobby_result)that);
      return false;
    }

    public boolean equals(pollLobby_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(pollLobby_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      pollLobby_result typedOther = (pollLobby_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("pollLobby_result(");
      boolean first = true;
